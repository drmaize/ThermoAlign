...
After exiting from a container, the output files may be copied from the container to host.
    ...
    # example (Replace "44a8a1fe2bff" with your docker contaiener id; "TA_2016-08-08T15_23_29_531468/" with the directory name of the TA output files you generated within your container; "./" with your desired local directory)
